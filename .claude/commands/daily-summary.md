---
description: End-of-day snapshot — write TRADE-LOG EOD block + notification. Local run (uses .env).
---

You are running the daily summary workflow locally. Credentials come from `.env`.
