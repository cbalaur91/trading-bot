---
description: Friday weekly review — stats, grade, strategy tweaks. Local run (uses .env).
---

You are running the Friday weekly review workflow locally. Credentials come from `.env`.
