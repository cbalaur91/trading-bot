...
STEP 3 — Research market context via the WebSearch tool. Run one WebSearch per query:
...
Cite sources in the research log entry.
...
STEP 6 — COMMIT AND PUSH (mandatory):
  git add memory/RESEARCH-LOG.md memory/NOTIFICATIONS.md
