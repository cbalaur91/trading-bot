...
- Week return ($ and %)
- S&P 500 week return: use the WebSearch tool with query "S&P 500 weekly performance week ending $DATE"
...
STEP 7 — COMMIT AND PUSH (mandatory):
  git add memory/WEEKLY-REVIEW.md memory/TRADING-STRATEGY.md memory/NOTIFICATIONS.md
  git commit -m "weekly review $DATE"
  git push origin main
If TRADING-STRATEGY.md didn't change, add just WEEKLY-REVIEW.md and NOTIFICATIONS.md. On push failure: git pull --rebase origin main, then push again. Never force-push.
